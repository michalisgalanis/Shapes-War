...
public class StatItem {
    ...
    public StatItem(Constants.Gameplay.Player.playerStatTypes statTypes) {
    ...
    public void EstimateStat() {
        switch (statType) {
            case Constants.Gameplay.Player.playerStatTypes.ATTACK_SPEED:
                ...
                statValue = Constants.Functions.getPlayerAttackSpeed(RuntimeSpecs.playerLevel, upgradeCounter, powerupFactor);
            ...
            case Constants.Gameplay.Player.playerStatTypes.MELEE_DAMAGE:
                ...
                upgradeCounter = rf.ss.findStoreItemByType(Constants.Gameplay.Store.storeItem.ATTACK_SPEED).counter;
                enemyPenaltyFactor = 0f;
                statValue = Constants.Functions.getPlayerMeleeDamage(RuntimeSpecs.playerLevel, upgradeCounter, powerupFactor, enemyPenaltyFactor);
                break;
            ...
            case Constants.Gameplay.Player.playerStatTypes.MOVEMENT_SPEED:
                ...
                enemyPenaltyFactor = 0f;
                statValue = Constants.Functions.getPlayerMovementSpeed(RuntimeSpecs.playerLevel, upgradeCounter, powerupFactor, enemyPenaltyFactor);
