...
public class JoystickMovement : MonoBehaviour {
    ...
    private static float DEAD_ZONE_WIDTH_THRESHOLD;
    private static float DEAD_ZONE_HEIGHT_THRESHOLD;
    ...
    public void Start() {
        ...
        DEAD_ZONE_WIDTH_THRESHOLD = Camera.main.pixelWidth * 0.05f;
        DEAD_ZONE_HEIGHT_THRESHOLD = Camera.main.pixelHeight * 0.065f;
    }
    ...
    private direction AnalyzeFinger(Touch finger) {
        ...
        if (finger.position.x >= (Camera.main.pixelWidth / 2f) - DEAD_ZONE_WIDTH_THRESHOLD && finger.position.x <= (Camera.main.pixelWidth / 2f) + DEAD_ZONE_WIDTH_THRESHOLD && finger.position.y <= DEAD_ZONE_HEIGHT_THRESHOLD) {
